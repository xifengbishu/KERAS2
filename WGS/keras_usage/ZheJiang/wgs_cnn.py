...
his=model.fit(data, label, batch_size=batch_size, nb_epoch=nb_epoch,shuffle=True,verbose=1,validation_split=0.6)
...
layer_output = get_3rd_layer_output([data])[0]
print ('layer5_output',layer_output.shape)

get_3rd_layer_output = K.function([model.layers[0].input],
                                  [model.layers[6].output])
layer_output = get_3rd_layer_output([data])[0]
print ('layer6_output',layer_output.shape)

get_3rd_layer_output = K.function([model.layers[0].input],
                                  [model.layers[7].output])
layer_output = get_3rd_layer_output([data])[0]
print ('layer7_output',layer_output.shape)

get_3rd_layer_output = K.function([model.layers[0].input],
                                  [model.layers[8].output])
layer_output = get_3rd_layer_output([data])[0]
print ('layer8_output',layer_output.shape)
